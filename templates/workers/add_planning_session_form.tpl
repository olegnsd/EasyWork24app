...
<div id="add_session_planning" class="add_form_margin" style="display:none">
<div class="title_add_form">Организовать планерку</div>
...
<tr>
    ...
    <td class="td_value"><div class="access_users_list_a_bl">{USER_WORKERS_LIST}</div>
