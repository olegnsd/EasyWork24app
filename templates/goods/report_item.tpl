<div class="user_cont_block {REPORT_NOT_CONFIRM_CLASS} report_for_task_{TASK_ID}" id="report_{REPORT_ID}">
<table cellpadding="0" cellspacing="0" >
	<tr>
        ...
        <div class="user_cont">
         	<div class="user_cont_text">{TASK_TEXT}</div>
            <div class="user_cont_sub">{TASK_DATE}</div>
            {CONFIRM_BTN}
        </div>        
        </td>
    </tr>
