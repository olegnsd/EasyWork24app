...
<div class="title_add_form">Создать заметку</div>
...
<table cellpadding="0" cellspacing="0" class="tables_data_1">
    ...
    <div class="right"></div><div class="left"></div><div class="btn_cont">создать</div></a></td>
...
<a href="javascript:;" class="link" onclick="$('#add_form_block').fadeIn(200); $('#show_add_form_a').hide()">+ Создать заметку</a>
</div>
