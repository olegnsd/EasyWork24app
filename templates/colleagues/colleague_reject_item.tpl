<div class="users_list_item colleague_item reject"  id="colleague_{INVITE_USER_ID}_{INVITED_USER_ID}">
<div class="content_hiiden_block_{INVITE_USER_ID}_{INVITED_USER_ID}">


<div class="user_list_action_block" style="width:205px">

Ваше предложение отклонено | <a href="javascript:;" onclick="hide_colleague_rejected_notice('{INVITE_USER_ID}', '{INVITED_USER_ID}')" class="link">Скрыть</a><br />
