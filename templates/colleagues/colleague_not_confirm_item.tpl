...
<div class="user_list_action_block" style="text-align:right; margin-right:6px">
<a href="javascript:;" onclick="delete_from_colleagues('{INVITE_USER_ID}', '{INVITED_USER_ID}')" class="link">Удалить заявку</a>
</div>
